...
const (
	ipcAPIs  = "admin:1.0 debug:1.0 eth:1.0 mev:1.0 miner:1.0 net:1.0 rpc:1.0 satoshi:1.0 txpool:1.0 web3:1.0"
...
func TestConsoleWelcome(t *testing.T) {
	...
	geth.SetTemplateFunc("niltime", func() string {
		return time.Unix(0x61936E60, 0).Format("Mon Jan 02 2006 15:04:05 GMT-0700 (MST)")
	})
