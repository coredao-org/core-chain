...
const (
	...
	FeeMarketSloadGas      uint64 = 200    // The gas added for each storage slot read from storage during fee market distribution
	...
	MaxFeeMarketRewardGasCapPerTx  = 20_000_000              // Amount of gas that can be rewarded at FeeMarket per transaction
	MaxFeeMarketRewardFeesCapPerTx = 600_000_000_000_000_000 // Amount of fees that can be rewarded at FeeMarket per transaction (MaxFeeMarketRewardGasCapPerTx * 30GWei)
